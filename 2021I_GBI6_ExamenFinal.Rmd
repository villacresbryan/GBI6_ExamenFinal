...
##En las tablas obtenidas se puede observar cada elemento, agrupado de acuerdo a el tipo de cancer y el nivel de expresion de cada gen. Se puede visualizar> varibale, tipo, numero de datos o muestras, la media, la moda, el rango.
...
# en el boxplot se puede observar el nivel del expresion para el tipo de cancer con codigo KIPR o sea el Carcinoma renal de células papilares.
#en el regresion11.pdf  se puede ver una comparacion el gen gata 3 con el gen fn1, donde se puede ver que el gen fn1 es mas agresivo debido que tiene mas puntos negros. 
```
